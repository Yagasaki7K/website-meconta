<p align="center">
   <img src="https://github.com/Yagasaki7K/website-meconta/blob/main/public/logo.png" width="500"/>
</p>
...
```bash
# Clone Repository
$ git clone https://github.com/Yagasaki7K/website-meconta.git
...
Feel free to **file a new issue** with a respective title and description on the the [meconta](https://github.com/Yagasaki7K/website-meconta/issues) repository. If you already found a solution to your problem, **i would love to review your pull request**!
...
* Check the [issues page](https://github.com/Yagasaki7K/website-meconta/issues) for already opened issues (or maybe even closed ones) that might already address your question/bug/feature request.
